...
import com.ltyc.sms.entity.cmpp30.msg.CmppDeliverResponseMessage;
import com.ltyc.sms.entity.cmpp30.msg.Message;
import com.ltyc.sms.entity.cmpp30.packet.Cmpp30DeliverResponse;
...
public class CmppDeliverResponseMessageCodec extends MessageToMessageCodec<Message, CmppDeliverResponseMessage> {
    ...
    protected void decode(ChannelHandlerContext ctx, Message msg, List<Object> out) throws Exception {
        ...
        responseMessage.setMsgId(DefaultMsgIdUtil.bytes2MsgId(toArray(bodyBuffer, Cmpp30DeliverResponse.MSGID.getLength())));
    ...
    protected void encode(ChannelHandlerContext ctx, CmppDeliverResponseMessage msg, List<Object> out) throws Exception {
        ...
        ByteBuf bodyBuffer = ctx.alloc().buffer(Cmpp30DeliverResponse.MSGID.getBodyLength());
